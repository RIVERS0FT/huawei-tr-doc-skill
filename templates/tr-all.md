...
> 输出格式：Markdown 文本  
> 适用场景：一次性组织项目从概念设计到发布交付的完整 TR 阶段文档。  
> 说明：本模板用于生成文档包。各阶段必须保持边界清晰，不应把后续阶段内容提前写入前序阶段。
...
| 阶段 | 文档名称 | 阶段重点 | 不应包含 |
|---|---|---|---|
| TR1 | 产品概念与可行性设计文档 | 项目背景、项目目标、用例分析、功能分析、设计范围、产品概念、概念可行性 | 提示词、输入解析、待确认问题、投入分析、具体技术选型、代码级设计 |
...
| 用例编号 | 用例名称 | 参与角色 | 触发条件 | 后置结果 | 优先级 |
|---|---|---|---|---|---|
| UC-001 | {{用例名称}} | {{角色}} | {{触发条件}} | {{后置结果}} | P0 |
...
| 风险编号 | 风险描述 | 影响 | 概率 | 等级 | 应对措施 | 状态 |
|---|---|---|---|---|---|---|
| R-001 | {{风险描述}} | {{影响}} | 高 / 中 / 低 | 高 / 中 / 低 | {{应对措施}} | Open |
