...
| 阶段 | 模板 | 模板作用 |
|---|---|---|
| TR1 | `templates/tr1.md` | 约束项目背景、项目目标、用例分析、功能分析、概念方案、概念可行性、Mermaid 图和初始风险结构 |
...
```md
> 设计假设：系统首期面向研发和测试人员使用，优先验证产品概念、核心用例和功能边界；具体技术路线在 TR3/TR4 阶段确定。
```
...
```md
| Q-001 | 首期最大 agent 数量尚未明确 | 影响规模边界和后续设计 | 产品 / 技术负责人 | TR2 前关闭 |
```
...
TR1 可以写“概念可行性”“实现条件”“后续需在 TR3/TR4 明确技术路线”，但不能做具体技术路线决策。
...
| 阶段 | 设计重点 | 生成深度 |
|---|---|---|
| TR1 | 项目背景、项目目标、用例分析、功能分析、概念方案、概念可行性、初始风险；不做技术选型 | 概念级，不写代码级细节，不确定具体技术栈 |
