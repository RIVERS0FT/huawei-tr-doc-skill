...
- **核心用例说明**：必须使用固定字段：用户目的、参与人员、前置条件、用例输入、用例流程、用例输出、功能调用。
...
- TR1 部分的核心用例说明必须使用固定字段：用户目的、参与人员、前置条件、用例输入、用例流程、用例输出、功能调用。
- TR3 才开始总体方案、架构和技术路线。
...
- TR1 用例说明必须包含用户目的、参与人员、前置条件、用例输入、用例流程、用例输出、功能调用。
...
- [ ] TR1 核心用例说明是否包含用户目的、参与人员、前置条件、用例输入、用例流程、用例输出、功能调用？
